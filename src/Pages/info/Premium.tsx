              ...
              <div className="grid gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <p className="text-slate-600">
                    ...
                    and wallets through our secure payment partner Razorpay.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <p className="text-slate-600">
                    While we don't offer a free trial, you can start with our
                    Free plan to explore the platform. You'll only upgrade when
                    you're ready to see who liked you and access premium
                    features.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <p className="text-slate-600">
                    If you downgrade, you'll lose access to premium features
                    like seeing who liked you and advanced matching. Your
                    profile and connections will remain, but premium benefits
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <p className="text-slate-600">
                    ...
                    gateway. We never store your card details on our servers.
