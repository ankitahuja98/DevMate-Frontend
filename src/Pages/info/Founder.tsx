...
const Founder: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Founder - Devmate"
        description="Meet the founder behind Devmate and the vision driving the platform."
      />
          ...
          <div className="max-w-6xl mx-auto">
                ...
                <div className="md:col-span-8 p-10 md:p-14 flex flex-col justify-center">
                  ...
                  <div className="prose prose-lg max-w-none text-slate-600 leading-relaxed space-y-4">
                    <p>
                      ...
                      full-stack applications, I built this platform to connect
                      developers meaningfully.
                    </p>
                    ...
                    <p>
                      ...
                      real-time communication to intelligent matching —
                      everything is engineered to feel seamless.
                    </p>
                    <p>
                      Beyond building the platform, I am committed to fostering
                      a community where developers can grow together.{" "}
                      <strong>Devmate</strong> is not just a tool, but a space
                      for collaboration, learning, and shared innovation —
                      empowering developers to turn their ideas into impactful
                      real-world projects. I envision a world where developers
                      can easily find the right partners, break through creative
                      barriers, and build confidently. Together, we can shape a
                      future where collaboration fuels every great idea.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-600 rounded-2xl shadow-2xl p-6 md:p-8 text-white">
              ...
              <p className="text-lg text-purple-100 leading-relaxed text-center max-w-3xl mx-auto">
                ...
                interests, and compatibility — making it easier than ever to
                find the right partners for collaboration.
              </p>
