...
const Features = () => {
  ...
  return (
    <>
      <SEO
        title="Devmate Features"
        description="Explore powerful features that help developers match, chat, and collaborate efficiently."
      />
        ...
        <div className="py-12 px-4 sm:px-6 lg:px-8 bg-white/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600">
                Stand out with a comprehensive profile that showcases your
