...
const Contact = () => {
  return (
    <>
      <SEO
        title="Contact Devmate"
        description="Contact the Devmate team for support, questions, or partnership opportunities."
      />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                ...
                share an idea, or just say hello — here are the best ways to
                reach me.
              </p>
