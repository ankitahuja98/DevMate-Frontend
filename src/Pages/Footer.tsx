            ...
            <div className="flex items-center space-x-3">
              <div className="bg-gradient-to-br from-purple-600 to-indigo-600 p-2 rounded-lg">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M14.25 2.5a.25.25 0 00-.25-.25H6A2.75 2.75 0 003.25 5v14A2.75 2.75 0 006 21.75h12A2.75 2.75 0 0020.75 19V9.147a.25.25 0 00-.25-.25H15a.75.75 0 01-.75-.75V2.5z" />
                  <path d="M15.75 2.824c0-.184.193-.301.336-.186l5.005 3.973c.151.12.036.389-.166.389H15.75V2.824z" />
                </svg>
              </div>
